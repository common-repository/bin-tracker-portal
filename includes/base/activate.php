...
class B1nTPortal_Activate {
    public static function b1nTPortal_activate() {
        flush_rewrite_rules();
        self::b1nTPortal_create_states_table();
    }
     ...
     * 
     */
    private static function b1nTPortal_create_states_table() {
        global $wpdb;
        $b1nTPortal_table_name = $wpdb->prefix.'b1nTPortal_states';
        $b1nTPortal_charset_collate = $wpdb->get_charset_collate();
